...
import formlayout
version = ".".join(formlayout.__version__.split('.')[:2])
# The full version, including alpha/beta/rc tags.
release = formlayout.__version__
...
modindex_common_prefix = ['formlayout.']
...
# of the sidebar.
#html_logo = 'images/formlayout.png'
...
latex_documents = [
  ('index', 'formlayout.tex', 'formlayout Manual', 'Pierre Raybaut', 'manual'),
]
